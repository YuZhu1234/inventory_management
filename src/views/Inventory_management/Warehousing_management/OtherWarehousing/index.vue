<template>
  ...
  >
    ...
    :loadOtherWarehousinglist="loadOtherWarehousinglist" 
...
import OtherWarehousingDetail from './OtherWarehousingDetail.vue'
...
export default defineComponent({
  ...
  setup () {
    ...
    const OtherWarehousinglist = ref([{}])
    const total = ref(0)
    ...
    const handleSearch = () => {
      loadOtherWarehousinglist(1, dateValue.value[1], dateValue.value[0], searchId.value)
    }
