<template>
  ...
  <el-form ref="service" :model="CustomerDetails" :label-width=LabeWidth label-position="right">
   <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="编码" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.customerCode" placeholder="客户编码"></el-input>
    </el-form-item>
    <el-form-item label="名称" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.name" placeholder="名称"></el-input>
    </el-form-item>
   </el-form>

   <el-form :inline="true" :model="formInline" class="demo-form-inline">
     <el-form-item label="简称" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.shortName" placeholder="简称"></el-input>
    </el-form-item>
    <el-form-item label="等级" :label-width=LabeWidth>
      <el-select v-model="CustomerDetails.customerLevelValue" placeholder="一级" class="option">
    ...
    <el-form :inline="true" class="demo-form-inline">
     <el-form-item label="纳税规模" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.taxScale_value" placeholder="请输入纳税规模"></el-input>
    </el-form-item>
    <el-form-item label="欠款额度" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.creditLimit" placeholder="请输入欠款额度"></el-input>
    </el-form-item>
   </el-form>

   <el-form :inline="true" class="demo-form-inline">
     <el-form-item label="客户分类" :label-width=LabeWidth>
      <el-select v-model="CustomerDetails.customerTypeValue" placeholder="一级" class="option">
    ...
    <el-form-item label="收件信息邮箱" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.postcodeReceipt" placeholder="请输入收件信息邮箱"></el-input>
    </el-form-item>
   </el-form>

   <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="所属地区" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.bizArea" placeholder="请输入所属地区"></el-input>
    </el-form-item>
    <el-form-item label="业务区域" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.area" placeholder="请输入业务区域"></el-input>
    </el-form-item>
   </el-form>

   <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="客户网站" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.website" placeholder="请输入客户网站"></el-input>
    </el-form-item>
    <el-form-item label="法人代表" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.corporate" placeholder="请输入法人代表"></el-input>
    </el-form-item>
   </el-form>

   <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="法人电话" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.corporatePhone" placeholder="请输入法人电话"></el-input>
    </el-form-item>
    <el-form-item label="财务信息联系人" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.contactsFinancial" placeholder="请输入财务信息联系人"></el-input>
    </el-form-item>
   </el-form>

   <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="财务信息联系电话" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.phoneFinancial" placeholder="请输入财务信息联系电话"></el-input>
    </el-form-item>
    <el-form-item label="开票信息单位名称" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.unitInvoice" placeholder="请输入开票信息单位名称"></el-input>
    </el-form-item>
   </el-form>

   <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="开票信息税号" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.taxInvoice" placeholder="请输入开票信息税号"></el-input>
    </el-form-item>
    <el-form-item label="开票信息联系电话" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.phoneInvoice" placeholder="请输入开票信息联系电话"></el-input>
    </el-form-item>
   </el-form>

   <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="办款资料单位名称" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.unitPayment" placeholder="请输入办款资料单位名称"></el-input>
    </el-form-item>
    <el-form-item label="开票信息账号" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.accountInvoice" placeholder="请输入开票信息账号"></el-input>
    </el-form-item>
   </el-form>

   <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="办款资料行号" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.bankidPayment" placeholder="请输入办款资料行号"></el-input>
    </el-form-item>
    <el-form-item label="办款资料账号" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.accountPayment" placeholder="请输入办款资料账号"></el-input>
    </el-form-item>
   </el-form>
   ...
   <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="收件信息收件人" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.addressReceipt" placeholder="请输入收件信息收件人"></el-input>
    </el-form-item>
    <el-form-item label="收件信息联系电话" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.phoneReceipt" placeholder="请输入收件信息联系电话"></el-input>
    </el-form-item>
   </el-form>

   <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="收件信息传真" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.faxReceipt" placeholder="请输入收件信息传真"></el-input>
    </el-form-item>
    <el-form-item label="备注" :label-width=LabeWidth>
      <el-input v-model="CustomerDetails.remark"  placeholder="请输入备注"></el-input>
    </el-form-item>
   </el-form>
  ...
  <el-form :inline="true" class="demo-form-inline">
    <el-form-item label="附件" :label-width=LabeWidth>
      ...
      <el-form-item label="是否启用" v-model="CustomerDetails.isEnabled" :label-width=LabeWidth>
      <div class="option">
